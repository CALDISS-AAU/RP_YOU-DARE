...
mapping_p = Path("/work/YOU-DARE/raw-data/mappings/actor_mapping.json/")
output_p = Path("/work/YOU-DARE/raw-data/mappings/actor_identifier_key/actor_colour_map/actor_value_colours.json")
