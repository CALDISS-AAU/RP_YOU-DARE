...
for dataset_path in list_of_SOURCE_1_dataset_paths:
    doccano.prepare_data_for_doccano(dataset_path, keywords=SOURCE_1_keywords, from_date=SOURCE_1_from_date, to_date=TEST_to_date)
