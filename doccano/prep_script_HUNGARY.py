...
HUNGARY_data_directory = '/work/YOU-DARE/scrapers/data/Hungary/fidesz_videos_YT' #'/work/YOU-DARE/scrapers/data/Hungary' # All datasets for the TEST-country (could also be e.g. '/work/YOU-DARE/scrapers/data/TEST_COUNTRY/Telegram' if one only want to prepare telegram datasets)
